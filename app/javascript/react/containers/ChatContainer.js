      ...
      <div className="app-component">
        ...
        <div className="example-chat-embed-container">
          <div className="example-chat-embed-box">
            {messages}
            <div className="example-chat-embed-box-invisible"
